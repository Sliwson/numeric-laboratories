...
\paragraph{}
Na początku zobaczymy rezultat działania algorytmu dla macierzy o różnych rozmiarach dla parametru $\omega$ równego $1.25$. Resztę parametrów pozostawimy domyślną, gdyż sprawdzenie wpływu każdego z nich wymagałoby utworzenia zbyt dużej ilości testów.
\begin{enumerate}
\item Macierz $5 \times 5 $ - jedyna jaką wpiszemy ręcznie podczas naszych testów:
$$A = \begin{bmatrix}
4 & 0 & 0 & 0 & 3\\
3 & 5 & 0 & 0 & 2\\
0 & 0 & 3 & 0 & 0\\
